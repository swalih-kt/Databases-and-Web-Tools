...
function displayResults() {
    ...
    pageData.forEach(row => {
        ...
        const displayKeys = ['refGene', 'HGVS_NM', 'HGVS_NP', 'dbSNP', 'Mutation', 'Pop', 'ACMG_Classification'];
...
function showDetailView(rowData) {
    ...
    // Section-wise keys
    const geneKeys = ['refGene','Build', 'Chr', 'Start', 'Ref', 'Alt', 'HGVS_NM', 'HGVS_NC', 'HGVS_NP', 'Mutation', 'GeographicalOrigin', 'AAChange'];
    const clinicalKeys = ['Disease', 'Technique', 'Mutation', 'Inheritance', 'dbSNP', 'MutationEffect','ACMG_Classification', 'Ethnicity','Pop'];
